...
Init_guess=list(N_0,J_0,L_0,gama1_0);
...
LME=list(R1-R1',R1*Bb1-Bb1*Rh1)
LMI=list(-([P211,P212,P213,P214;P212',P222,P223,P224;P213',P223',P233,P234;P214',P224',P234',P244]),R1,gama4)
OBJ=[]
endfunction
...
Init_guess_DRC1=list(R1_0,Rh1_0,Khx_0,Khw_0,gama4_0);
